...
export const Message = forwardRef(
    ({ width = '2.6rem', height = '2.6rem', className }, ref) => {
        return (
            <svg
                ref={ref}
...
export const Search = forwardRef(
    ({ width = '1.6rem', height = '1.6rem', className }, ref) => {
        return (
            <svg
                ref={ref}
                className={classNames(className)}
    ...
    ({ width = '3.2rem', height = '3.2rem', className }, ref) => {
        return (
            <svg width={width}
                height={height}
                className={classNames(className)}
                fill="currentColor" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M24.9505 7.84001C24.3975 7.38666 23.6014 7.38666 23.0485 7.84003L6.94846 21.04C6.45839 21.4418 6.2737 22.1083 6.48706 22.705C6.70041 23.3017 7.26576 23.7 7.89949 23.7H10.2311L11.4232 36.7278C11.5409 38.0149 12.6203 39 13.9128 39H21.5C22.0523 39 22.5 38.5523 22.5 38V28.3153C22.5 27.763 22.9477 27.3153 23.5 27.3153H24.5C25.0523 27.3153 25.5 27.763 25.5 28.3153V38C25.5 38.5523 25.9477 39 26.5 39H34.0874C35.3798 39 36.4592 38.0149 36.577 36.7278L37.7691 23.7H40.1001C40.7338 23.7 41.2992 23.3017 41.5125 22.705C41.7259 22.1082 41.5412 21.4418 41.0511 21.04L24.9505 7.84001Z"></path></svg>
        );
    },
);

export const GroupUserIcon = forwardRef(
    ({ width = '3.2rem', height = '3.2rem', className }, ref) => {
        return (
            <svg
                width={width}
...
export const GroupUserIconActive = forwardRef(
    ({ width = '3.2rem', height = '3.2rem', className }, ref) => {
        return (
            <svg width={width}
                height={height}
