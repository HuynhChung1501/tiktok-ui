...
export const Message = forwardRef(({ width = '2.6rem', height = '2.6rem', className }, ref) => {
    return (
        <svg
            ref={ref}
...
export const Inbox = forwardRef(({ width = '3.2rem', height = '3.2rem', className }, ref) => {
    return (
        <svg
            ref={ref}
            className={classNames(className)}
...
export const Search = forwardRef(({ width = '1.6rem', height = '1.6rem', className }, ref) => {
    return (
        <svg
            ref={ref}
            className={classNames(className)}
